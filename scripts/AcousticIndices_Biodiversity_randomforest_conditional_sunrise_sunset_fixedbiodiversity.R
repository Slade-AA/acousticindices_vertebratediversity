...
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset_fixedbiodiversity/Birds_MorningDayAll_cforest.png",
...
Plot_AllRF <- plot_grid(Plot_AllRF, legend_bottom,
                        ncol = 1, 
                        rel_heights = c(1, 0.1))
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset_fixedbiodiversity/AllComparisons_cforest.png",
       plot = Plot_AllRF,
       width = 30, height = 10, units = "cm", dpi = 800)


#New boxplot version for just MAE
MAE_values <- list()
...
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset_fixedbiodiversity/MAE_norm_cforest.png",
...
save(randomforest_spearman, file = "outputs/figures/randomforestobspred_sunrise_sunset_fixedbiodiversity/randomforest_spearman.RData")


#Load individual bootstrap correlation values and make table

load(file = "outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bestindex_spearman.RData")
...
write.csv(spearman_individual_rf_comparison[,c(4,5,6,3,2)] %>% mutate(across(where(is.numeric), round, 2)), 
          file = "outputs/figures/correlationTable_individual_vs_randomforest_sunrise_sunset_fixedbiodiversity.csv",
...
save.image(file = "outputs/workspaces/RandomForest_cforest_sunrise_sunset_fixedbiodiversity.RData")