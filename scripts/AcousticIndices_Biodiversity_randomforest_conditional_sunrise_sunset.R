...
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset/Birds_MorningDayAll_cforest.png",
...
Plot_AllRF <- plot_grid(Plot_AllRF, legend_bottom,
                        ncol = 1, 
                        rel_heights = c(1, 0.1))
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset/AllComparisons_cforest.png",
       plot = Plot_AllRF,
...
ggsave(filename = "outputs/figures/randomforestperformance_sunrise_sunset/MAE_norm_cforest.png",
...
ggsave(filename = "outputs/figures/randomforestobspred_sunrise_sunset/ObservedPredicted_cforest.png",
...
ggsave(filename = "outputs/figures/randomforestvariableimportance_sunrise_sunset/VariableImportance_cforest.png",
       plot = Plot_VariableImportance,
       width = 20, height = 20, units = "cm", dpi = 800)

# Save workspace for later loading ----------------------------------------

save.image(file = "outputs/workspaces/RandomForest_cforest_sunrise_sunset.RData")