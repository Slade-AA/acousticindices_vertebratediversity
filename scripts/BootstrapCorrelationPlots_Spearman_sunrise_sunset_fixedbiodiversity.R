...
ggsave("outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bootstrap_correlations_birdsACI_spearman.png",
...
ggsave("outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bootstrap_correlations_birds_spearman.png",
...
ggsave("outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bootstrap_correlations_frogs_spearman.png",
...
ggsave("outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bootstrap_correlations_bytaxa_spearman.png",
       correlationPlot,
...
write_csv(bootCor_results_table,
          file = "outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/correlationTable_spearman.csv")
...
save(bestindex_spearman, file = "outputs/figures/bootstrapcorrelations_sunrise_sunset_fixedbiodiversity/bestindex_spearman.RData")
  
# Save workspace for later loading ----------------------------------------

save.image(file = "outputs/workspaces/BootstrapCorrelations_spearman_sunrise_sunset_fixedbiodiversity.RData")